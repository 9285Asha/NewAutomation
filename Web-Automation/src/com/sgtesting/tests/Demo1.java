...
public class Demo1 
{
	...
	static void creatuser()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.name("firstName")).sendKeys("asha");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("lastName")).sendKeys("s");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("email")).sendKeys("asha@gmail.com");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("username")).sendKeys("ashasubbaiah");
			Thread.sleep(2000);
