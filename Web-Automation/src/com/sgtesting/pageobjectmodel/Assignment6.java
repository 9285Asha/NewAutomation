...
public class Assignment6 
{
	...
	static void createproject()
	{
		try 
		{
			...
			Thread.sleep(2000);
			oPage.getProjectName().sendKeys("Project");
			Thread.sleep(2000);
	...
	static void modifyproject()
	{
		try 
		{
			oPage.getModifyProjectButton().click();
			Thread.sleep(2000);
			oPage.getProjectModificationDescription().sendKeys("SG software Testing");
			Thread.sleep(2000);
			oPage.getProjectModificationDescriptionsave().click();
			Thread.sleep(4000);
		}
		catch (Exception e) 
		{
